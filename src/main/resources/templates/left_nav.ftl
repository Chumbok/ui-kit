<div class="dash-navbar-left">
    ...
    <div class="list-group panel">
        ...
        <a href="#menu1" class="list-group-item collapsed" data-toggle="collapse" data-parent="#sidebar"
           aria-expanded="false"><i class="fa fa-dashboard"></i> <span class="hidden-sm-down">&nbsp;Dashboard</span> </a>
        ...
        <a href="#" class="list-group-item collapsed" data-parent="#sidebar"><i class="fa fa-cog"></i> <span
                class="hidden-sm-down">&nbsp;Settings</span></a>
