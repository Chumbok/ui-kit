...
export class EditTemplateComponent implements OnInit {
  ...
  onSubmit() {
    ...
    var chiefComplainTemplate = String(this.form.controls['chiefComplain'].value).split(',');

    chiefComplainTemplate.forEach(function (chiefComplain) {
